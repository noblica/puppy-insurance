      ...
      <nord-stack gap="xl">
        <nord-stack>
          ...
          <div
            ...
            role="status"
            aria-live="polite"
            class="n:flex n:flex-col n:gap-2xs"
          >
            <div
              :class="`n:flex n:items-center n:gap-xs n:text-s ${r$.password.$rules.minLength.$valid ? 'n:text-success' : 'n:text-error'}`"
            >
              <nord-icon
                :name="
                  r$.password.$rules.minLength.$valid
            ...
            <div
              :class="`n:flex n:items-center n:gap-xs n:text-s ${r$.password.$rules.containsUppercase.$valid ? 'n:text-success' : 'n:text-error'}`"
            >
              <nord-icon
                :name="
                  r$.password.$rules.containsUppercase.$valid
                    ? 'interface-checked-small'
                    : 'interface-close-small'
                "
                class="n:shrink-0"
            ...
            <div
              :class="`n:flex n:items-center n:gap-xs n:text-s ${r$.password.$rules.containsNumber.$valid ? 'n:text-success' : 'n:text-error'}`"
            >
              <nord-icon
                :name="
                  r$.password.$rules.containsNumber.$valid
                    ? 'interface-checked-small'
                    : 'interface-close-small'
                "
                class="n:shrink-0"
            ...
            <div
              :class="`n:flex n:items-center n:gap-xs n:text-s ${r$.password.$rules.containsSpecialCharacter.$valid ? 'n:text-success' : 'n:text-error'}`"
            >
              <nord-icon
                :name="
                  r$.password.$rules.containsSpecialCharacter.$valid
                    ? 'interface-checked-small'
                    : 'interface-close-small'
                "
                class="n:shrink-0"
